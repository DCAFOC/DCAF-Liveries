...
-- F16_bl50_Main_2
	{"F16_bl50_Main_2",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_Main_2",	false};
	{"F16_bl50_Main_2",	1,	                "f16_bl50_main_2_normal",	true};
	{"F16_bl50_Main_2",	ROUGHNESS_METALLIC,	"f16_bl50_main_2_roughmet",	true};
	
-- F16_bl50_Main_3
	{"F16_bl50_Main_3",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_Main_3",			false};
	{"F16_bl50_Main_3",	1,	                "f16_bl50_main_3_normal",	true};
	{"F16_bl50_Main_3",	ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_main_3_roughmet",	false};
	
-- F16_bl50_Kil
	{"F16_bl50_Kil",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_Kil",				false};
	{"F16_bl50_Kil",	1,	                "f16_bl50_kil_normal",		true};
	{"F16_bl50_Kil",	ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_Kil_roughmet",	false};

-- F16_bl50_wing_L
	{"F16_bl50_wing_L",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_Wing_L",			false};
	{"F16_bl50_wing_L",	1,	                "f16_bl50_wing_l_normal",	true};
	{"F16_bl50_wing_L",	ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_wing_l_roughmet",	false};
	
-- F16_bl50_wing_R
	{"F16_bl50_wing_R",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_Wing_R",			false};
	{"F16_bl50_wing_R",	1,	                "f16_bl50_wing_r_normal",	true};
	{"F16_bl50_wing_R",	ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_wing_r_roughmet",	false};
	
	
-- F16_bl50_Engine
	{"F16_bl50_Engine",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_engine",			false};
	{"F16_bl50_Engine",	1,	                "f16_bl50_engine_normal",	true};
	{"F16_bl50_Engine",	ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_engine_roughmet",	false};


-- F16_bl50_Glass
	{"F16_bl50_GLASS",	DIFFUSE			,	"../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_Glass", false};
	{"F16_bl50_GLASS",	SPECULAR			,	"f16_bl50_glass_roughmet", true};
	{"F16_bl50_GLASS",	14,	"f16_bl50_glass_yellow", true};

	{"F16_bl50__GLASS_СLear",	DIFFUSE			,	"../(v)RNLAF 323rd Squadron 1981-1992/F16_bl50_Glass", false};
	{"F16_bl50__GLASS_СLear",	SPECULAR			,	"f16_bl50_glass_roughmet", true};
...
-- F16_bl50_Fuel_Tank_300Gal
	...
	--{"PTB_300Gal", 13, "Fuel_Tank_300Gal_RoughMet", false};
	
	
-- F16_bl50_Fuel_Tank_370Gal
	
	--{"Tank_370", 0, "fuel_tank_370gal_diff", false};
	--{"Tank_370", 	13, "fuel_tank_370gal_diff_RoughMet", false};
...
-- Pilot
	...
	{"pilot_F16_patch",	 0,	                    "../(v)RNLAF 323rd Squadron 1981-1992/pilot_f16_patch",				false};
	{"pilot_F16_patch",	 1,	                    "../(v)RNLAF 323rd Squadron 1981-1992/pilot_f16_patch_nm",			false};
	{"pilot_F16_patch",	 ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/pilot_f16_patch_roughmet",		false};
	...
	{"pilot_F16_helmet_glass",	SPECULAR,		"../(v)RNLAF 323rd Squadron 1981-1992/pilot_f16_visor_roughmet", false};
	{"pilot_F16_helmet_glass",	14,				"../(v)RNLAF 323rd Squadron 1981-1992/pilot_F16_visor_filtr", false};
	

-- BORT NUMBER--------------------------------------------------------------------------------------------------------------

--F16_bl50_FIN_DECAL	
    {"F16_bl50_FIN_DECAL",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_kil",				false};
	{"F16_bl50_FIN_DECAL",	1,	                "f16_bl50_kil_normal",		true};
	{"F16_bl50_FIN_DECAL",	ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_kil_roughmet",	false};
	{"F16_bl50_FIN_DECAL",	DECAL,	            "empty",	true};

--F16_bl50_FIN_BORT_NUMBER
    {"F16_bl50_FIN_BORT_NUMBER",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_kil",				false};
	{"F16_bl50_FIN_BORT_NUMBER",	1,	                "f16_bl50_kil_normal",		true};
	{"F16_bl50_FIN_BORT_NUMBER",	ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_kil_roughmet",	false};
	{"F16_bl50_FIN_BORT_NUMBER",	DECAL,	                  "../(v)RNLAF 323rd Squadron 1981-1992/F16_bort_number",	false};
...
--F16_bl50_INTAKE_BORT_NUMBER	
    {"F16_bl50_INTAKE_BORT_NUMBER",	0,	                "../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_main_3",				false};
	{"F16_bl50_INTAKE_BORT_NUMBER",	1,	                "f16_bl50_main_3_normal",		true};
	{"F16_bl50_INTAKE_BORT_NUMBER",	ROUGHNESS_METALLIC,	"../(v)RNLAF 323rd Squadron 1981-1992/f16_bl50_main_3_roughmet",		false};
...
name = "(v)RNLAF 323rd Squadron J-200"
